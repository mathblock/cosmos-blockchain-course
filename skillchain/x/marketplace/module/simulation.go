...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	const (
		opWeightMsgAcceptApplication          = "op_weight_msg_marketplace"
		defaultWeightMsgAcceptApplication int = 100
	)

	var weightMsgAcceptApplication int
	simState.AppParams.GetOrGenerate(opWeightMsgAcceptApplication, &weightMsgAcceptApplication, nil,
		func(_ *rand.Rand) {
			weightMsgAcceptApplication = defaultWeightMsgAcceptApplication
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgAcceptApplication,
		marketplacesimulation.SimulateMsgAcceptApplication(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgRejectApplication          = "op_weight_msg_marketplace"
		defaultWeightMsgRejectApplication int = 100
	)

	var weightMsgRejectApplication int
	simState.AppParams.GetOrGenerate(opWeightMsgRejectApplication, &weightMsgRejectApplication, nil,
		func(_ *rand.Rand) {
			weightMsgRejectApplication = defaultWeightMsgRejectApplication
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgRejectApplication,
		marketplacesimulation.SimulateMsgRejectApplication(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgDeliverContract          = "op_weight_msg_marketplace"
		defaultWeightMsgDeliverContract int = 100
	)

	var weightMsgDeliverContract int
	simState.AppParams.GetOrGenerate(opWeightMsgDeliverContract, &weightMsgDeliverContract, nil,
		func(_ *rand.Rand) {
			weightMsgDeliverContract = defaultWeightMsgDeliverContract
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
	...
	const (
		opWeightMsgDisputeContract          = "op_weight_msg_marketplace"
		defaultWeightMsgDisputeContract int = 100
	)

	var weightMsgDisputeContract int
	simState.AppParams.GetOrGenerate(opWeightMsgDisputeContract, &weightMsgDisputeContract, nil,
		func(_ *rand.Rand) {
			weightMsgDisputeContract = defaultWeightMsgDisputeContract
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDisputeContract,
		marketplacesimulation.SimulateMsgDisputeContract(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgOpenDispute          = "op_weight_msg_marketplace"
		defaultWeightMsgOpenDispute int = 100
	)

	var weightMsgOpenDispute int
	simState.AppParams.GetOrGenerate(opWeightMsgOpenDispute, &weightMsgOpenDispute, nil,
		func(_ *rand.Rand) {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		marketplacesimulation.SimulateMsgOpenDispute(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgSubmitEvidence          = "op_weight_msg_marketplace"
	...
	const (
		opWeightMsgResolveDispute          = "op_weight_msg_marketplace"
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		marketplacesimulation.SimulateMsgResolveDispute(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
